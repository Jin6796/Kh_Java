...
// 반드시 ActionServlet을 경유한 뒤에  Board2Contoller가 실행되어야 한다.
// 왜?? >> Board2Controller가 servlet이 아니니까유!!
// 나는 서블릿이 아니다. 왜냐! ActionServlet에서 받으면 되거덩~
// 리턴타입을 String으로 바꿔볼까? >> 오 페이지 이동!
// 1-3에서는 req, res없이도 페이지 이동이 되게 설정.
// MVC패턴의 완결편? : 더 이상 상속관계로 재사용이나 클래스 설계를 안하는 것.
public class Board2Controller implements Controller {
	...
	public String execute(HttpServletRequest req, HttpServletResponse res) 
		...
		String page = ""; // null로 두는 것이 맞지만 웹서비스에서 NullPointerException 발생시
