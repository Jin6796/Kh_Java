...
class BorderLayoutView_1_1 implements ActionListener{ 
...
public class BorderLayoutApp_1_1 {
	
	public static void main(String[] args) {
		//insert here
		//클래스타입 변수명(주소번지 출력) = new 클래스명();
		BorderLayoutView_1_1 blView_1 = new BorderLayoutView_1_1();
