...
public class AddressVO implements Serializable {
	...
	// 10-18번라인에 있는 애들은 테이블에 존재한 컬럼이고, 
	// 그 후 선언된 애들은 개발자가 업무를 처리하기 위해 필요한 부분을 담기 위해 선언. (insert, update, delete, select, selectall)
	private String name;
	...
	private String command; // 입력, 수정, 삭제, 조회를 위해!!
